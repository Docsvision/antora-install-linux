...
[CAUTION]
====
В {os1} 1.7 поставляется устаревшая версия .NET, в связи с этим необходимо подключить репозиторий Microsoft с актуальной версией. Во всех поддерживаемых ОС, кроме {os1} 1.7, версия .NET обновится до актуальной автоматически, поэтому данный шаг можно пропустить.
====
