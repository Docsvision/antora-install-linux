...
+
После установки и настройки  {wc}а, выполните настройку программ панели управления {wc}ом и Конструктора Web-разметок. См. раздел "xref:6.1@webclient:admin:install-server.adoc#kvr-pu[Установка программ Конструктор Web-разметок и Панель управления]" в документации по администрированию {wc}а.
+
