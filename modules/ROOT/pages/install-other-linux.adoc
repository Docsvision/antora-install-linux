...
Расширение сервера приложений для {of-mc} включает связанные с модулем ресурсы локализации, обработчики и (при наличии) специализированные редакторы для {of-mc}.
