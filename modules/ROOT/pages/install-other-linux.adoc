...
+
 $ sudo systemctl start dvappserver && sudo systemctl start dvwebclient && sudo systemctl start dvsettings && sudo systemctl start dvexternalapi && sudo systemctl start dvconsole && sudo systemctl start dvworkerservice && sudo systemctl start dvworkflow && sudo systemctl start dvfileservice
