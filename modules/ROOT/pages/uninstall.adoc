...
{os3}::
+
 $ sudo apt-get remove --purge docsvision-webclient
====
+
...
{os3}::
+
 $ sudo apt-get remove --purge docsvision-managementconsole
====
+
...
{os3}::
+
 $ sudo apt-get remove --purge docsvision-ext-ws-mc
====
+
...
{os2}::
+
 $ sudo dnf remove package docsvision-ext-platform-mc

{os3}::
+
 $ sudo apt-get remove --purge docsvision-platform-mc
====
+
...
{os2}::
+
 $ sudo dnf remove package docsvision-ext-webc-mc

{os3}::
+
 $ sudo apt-get remove --purge docsvision-ext-webc-mc
====
+
...
{os2}::
+
 $ sudo dnf remove package docsvision-ext-workflow-mc

{os3}::
+
 $ sudo apt-get remove --purge docsvision-ext-workflow-mc
====
+
...
{os2}::
+
 $ sudo dnf remove package docsvision-ext-fileservice-mc

{os3}::
+
 $ sudo apt-get remove --purge docsvision-ext-fileservice-mc
====
+
...
{os2}::
+
 $ sudo dnf remove package docsvision-fileservice

{os3}::
+
 $ sudo apt-get remove --purge docsvision-fileservice
====
+
.. Удаление Службы {ws}:
+
...
{os3}::
+
 $ sudo apt-get remove --purge docsvision-workerservice
====
+
.. Удаление модуля {pl}:
+
...
{os3}::
+
 $ sudo apt-get remove --purge docsvision-platform
====
+
.. Удаление модуля {wf}:
+
...
{os3}::
+
 $ sudo apt-get remove --purge docsvision-workflow
====
+
